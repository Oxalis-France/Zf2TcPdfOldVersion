 ...
 * il faut imp�rativement inclure le fichier de config
 * avant d'instancier la classe TCPDF sinon ca ne marchera pas
 */
		...
		*/
		...
		public function Footer() {
			if ($this->print_footer) {
				...
				$this->SetX($this->original_rMargin);
				$this->Cell(0 , $footer_height , date('d/m/Y H:i') , 'T' , 0 , 'L') ;
				// restore line width
				$this->SetLineWidth($prevlinewidth);
			}
		}
